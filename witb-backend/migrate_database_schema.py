...
async def migrate_database():
    ...
    async with engine.begin() as conn:
        try:
            ...
            print("📝 Setting initial last_updated timestamps for existing WITB items...")
            ...
            print("📊 Current player last_updated values (these will now represent WITB data updates):")
            result = await conn.execute(text("""
            ...
            print("   • Players.last_updated now only changes when WITB data is scraped")
            print("   • OWGR updates will be tracked separately in system_updates table")
