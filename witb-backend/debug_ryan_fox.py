    ...
    try:
        ...
        if equipment:
            ...
            if all_tables:
                ...
                print(f"  Parent div classes: {first_table.parent.get('class', 'None') if first_table.parent else 'None'}")
                ...
                if len(rows) > 1:
                    ...
                    print(f"  First row cells: {[cell.get_text().strip() for cell in cells]}")
