...
class TestScoreParsing:
    ...
    def test_numeric_score_conversion_negative(self):
        ...
        for competitor_data, expected_score in test_cases:
            ...
            assert actual_score == expected_score, f"Failed for {competitor_data}: expected {expected_score}, got {actual_score}"
    ...
    def test_score_formatting_display(self):
        ...
        for input_score, expected_display in test_cases:
            ...
            assert actual_display == expected_display, f"Failed for {input_score}: expected {expected_display}, got {actual_display}"
        ...
        mock_data = {
            "events": [{
                ...
                "competitions": [{
                    ...
                    "competitors": [
                        {"athlete": {"displayName": "Justin Rose"}, "score": "-16"}
                    ]
                }]
            }]
        }
        ...
        mock_data = {
            "events": [{
                ...
                "competitions": [{
                    "status": {"type": {"name": "STATUS_FINAL"}},
                    "competitors": [
                        {"athlete": {"displayName": "Player C"}, "score": "-10"},
                        {"athlete": {"displayName": "Justin Rose"}, "score": "-16"},  # Best score
                        {"athlete": {"displayName": "Player A"}, "score": "-5"},
                        {"athlete": {"displayName": "J.J. Spaun"}, "score": "-15"},
                    ]
                }]
            }]
        }
    ...
    async def test_get_winner_witb_player_found(self):
        ...
        with patch('tournament_scraper.engine') as mock_engine:
            ...
            mock_result.fetchall.return_value = [
                ('player-id', 'Justin Rose', 'Driver', 'TaylorMade', 'GT2', None, 'Shaft1'),
                ('player-id', 'Justin Rose', 'Putter', 'Odyssey', 'Model', None, 'Grip1'),
            ]
