...
class TestPlayerService:
    ...
    async def test_get_player_by_id_invalid_uuid_raises_http_exception(self, player_service):
        ...
        assert "Invalid player ID format" in str(exc_info.value) or exc_info.value.status_code == 400
    ...
    async def test_search_player_exists_returns_boolean(self, player_service):
        ...
        player_service.player_repo.search_player_by_name.assert_called_once_with(test_name)