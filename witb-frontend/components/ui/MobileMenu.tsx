...
export function MobileMenu({ isOpen, onClose }: MobileMenuProps) {
  ...
  const menuContent = (
    <>
      ...
      <div
        ref={menuRef}
        className={`fixed top-0 left-0 h-full w-80 bg-white dark:bg-gray-900 shadow-2xl z-[70] transform transition-all duration-[400ms] md:hidden ${
          ...
          <>
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 p-4">
              <button
                ...
                className="w-full flex items-center gap-3 p-3 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors disabled:opacity-50"
              >
